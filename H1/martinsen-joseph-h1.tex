...
\begin{figure}[h!]
\centering{}\includegraphics{inceven} \caption{Plot for Increasing/Decreasing Even Numbers}
\label{fig:1} 
\end{figure}
...
\begin{align*}
  f(x) = 2.88539 \ln(x) + 1 &\leq 3 \ln(x) + \ln(x) \\
  &\leq 4\ln(x)
\end{align*}
The Big-O asymptotic classification of this algorithm is $O(\ln(x))$ with $C=4$ and $k > 1$ as witnesses 
